 ...
 * @since 2.7.5
 */
public class TZookeeperServiceDiscoveryChangeWatcher implements CuratorWatcher {

    private final TZookeeperServiceDiscovery zookeeperServiceDiscovery;

    private final String serviceName;

    public TZookeeperServiceDiscoveryChangeWatcher(TZookeeperServiceDiscovery zookeeperServiceDiscovery,
                                                  String serviceName) {
