 ...
 */
public class TZookeeperServiceDiscovery implements ServiceDiscovery, EventListener<ServiceInstancesChangedEvent> {
    ...
    protected void registerServiceWatcher(String serviceName) {
        ...
        CuratorWatcher watcher = watcherCaches.computeIfAbsent(path, key ->
                new TZookeeperServiceDiscoveryChangeWatcher(this, serviceName));
        try {
